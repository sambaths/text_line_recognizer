# Code taken from : https://github.com/luisvalesilva/digitre/blob/master/digitre/digitre_preprocessing.py
"""Used to preprocess incoming data"""
import time
import base64
...
def reshape_array(img_ndarray):
    ...
    """
    char = np.reshape(img_ndarray, (28, 28))
    return char
